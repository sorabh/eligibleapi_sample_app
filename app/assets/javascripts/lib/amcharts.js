...
AmCharts.AmChart = AmCharts.Class({construct:function () {
  ...
  drawTitles:function () {
    ...
    a = {x:a, y:b, text:d, align:e, size:f, color:g, alpha:i, rotation:h, bold:j, url:k};
...
AmCharts.Cuboid = AmCharts.Class({construct:function (a, b, d, e, f, g, h, i, j, k, l, m, r) {
  this.set = a.set();
  this.container = a;
  this.h = Math.round(d);
  this.w = Math.round(b);
  ...
  var b = this.container, d = this.w, e = this.h, f = this.dx, g = this.dy, h = this.colors, i = this.alpha, j = this.bwidth,
      k = this.bcolor, l = this.balpha, m = this.gradientRotation, r = this.cornerRadius, p = h, q = h;
  "object" == typeof h && (p = h[0], q = h[h.length - 1]);
  if (0 < f || 0 < g) {
    var n = q, q = AmCharts.adjustLuminosity(p, -0.2), q = AmCharts.adjustLuminosity(p, -0.2), s = AmCharts.polygon(b, [0, f, d + f, d, 0], [0, g, g, 0, 0], q, i, 0, 0, 0, m);
    ...
    var y = AmCharts.polygon(b, [0, 0, f, f, 0], [0,
      e, e + g, g, 0], q, i, 0, 0, 0, m), x = AmCharts.polygon(b, [d, d, d + f, d + f, d], [0, e, e + g, g, 0], q, i, 0, 0, 0, m);
  ...
  1 > Math.abs(e) && (e = 0);
  1 > Math.abs(d) && (d = 0);
  b = 0 == e ? AmCharts.line(b, [0, d], [0, 0], p, l, j) : 0 == d ? AmCharts.line(b, [0, 0], [0, e], p, l, j) : 0 < r ? AmCharts.rect(b, d, e, h, i, j, k, l, r, m) : AmCharts.polygon(b, [0, 0, d, d, 0],
...
AmCharts.AmLegend = AmCharts.Class({construct:function () {
  ...
  var a = this.position, b = this.marginLeft + this.titleWidth, d = this.marginRight, e = this.marginTop, f = this.marginBottom, g = this.horizontalGap, h = this.div, i = this.divWidth, j = this.maxColumns,
      k = this.verticalGap, l = this.spacing, m = i - d - b, r = 0, p = 0, q = this.container, n = q.set();
  this.set = n;
  q = q.set();
  n.push(q);
  for (var s = this.entries, t = 0; t < s.length; t++) {
    var u = s[t].getBBox(), w = u.width;
    w > r && (r = w);
    u = u.height;
    u > p && (p = u)
  }
...
AmCharts.AmBalloon = AmCharts.Class({construct:function () {
  ...
  if (!isNaN(a)) {
    ...
    if (this.show) {
      ...
      var m = this.balloonColor, r = this.fillColor, p = this.borderColor;
      void 0 != m && (this.adjustBorderColor ? p = m : r = m);
      var q = this.horizontalPadding, n = this.verticalPadding, m = this.pointerWidth, s = this.pointerOrientation, t = this.cornerRadius,
    ...
    for (var j = 0; j < e.length; j++) {
      ...
      for (var p = 0; p < r.length; p++) {
        ...
        for (var n = 0; n < a.length; n++) {
          var m = a[n], s = m.id, t = m.periodValue;
          if (m.valueAxis.id == q) {
            k.axes[q].graphs[s] = {};
            var u = {};
            u.index = j;
...
AmCharts.TrendLine = AmCharts.Class({construct:function () {
  ...
  var a = this;
  a.destroy();
  var b = a.chart, d = b.container, e, f, g, h, i = a.categoryAxis, j = a.initialDate, k = a.initialCategory, l = a.finalDate, m = a.finalCategory, r = a.valueAxis, p = a.valueAxisX, q = a.initialXValue, n = a.finalXValue, s = a.initialValue, t = a.finalValue, u = r.recalculateToPercents;
...
AmCharts.ValueAxis = AmCharts.Class({inherits:AmCharts.AxisBase, construct:function () {
  ...
  if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))this.fire("logarithmicAxisFailed", {type:"logarithmicAxisFailed", chart:a}); else {
    ...
    if (!isNaN(this.min) &&
      ...
      var k = this.labelFrequency, l = this.showFirstLabel, m = this.showLastLabel, r = 1, p = 0, q = Math.round((this.max - this.min) / this.step) + 1;
      if (!0 == i) {
      ...
      if (0 < u) {
        ...
        for (e = this.fillAlpha = 0; e < u; e++) {
          var y = t[e], x = NaN;
          if (!isNaN(y.toValue)) {
            var x = this.getCoordinate(y.toValue), v = new this.axisItemRenderer(this, x, "", !0, NaN, NaN, y);
            this.pushAxisItem(v)
          }
          var D = NaN;
      ...
      t = !1;
      for (e = p; e < q; e +=
          r)v = AmCharts.roundTo(this.step * e + this.min, d), -1 != String(v).indexOf("e") && (t = !0, String(v).split("e"));
      ...
      for (e = p; e < q; e += r)if (p = this.step * e + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !(this.integersOnly && Math.round(p) != p)) {
        ...
        t ? (v = -1 == String(p).indexOf("e") ? p.toExponential(15) :
            String(p), v = v.split("e"), d = Number(v[0]), v = Number(v[1]), d = AmCharts.roundTo(d, 14), 10 == d && (d = 1, v += 1), v = d + "e" + v, 0 == p && (v = "0"), 1 == p && (v = "1")) : (i && (d = String(p).split("."), s.precision = d[1] ? d[1].length : -1), v = this.usePrefixes ? AmCharts.addPrefix(p, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, s) : AmCharts.formatNumber(p, s, s.precision));
        ...
        if (p == this.baseValue && "radar" != j) {
          var K, F, u = this.viW, w = this.viH, p = this.viX, v = this.viY;
  ...
  "100% stacked" == b && (b = "100%");
  this.stackType = b;
  var d = [], e = [], f = [], g = [], h, i = this.chart.graphs, j, k, l, m, r = this.baseValue;
...
AmCharts.CategoryAxis = AmCharts.Class({inherits:AmCharts.AxisBase, construct:function () {
  ...
  if (AmCharts.ifArray(a)) {
    ...
    var m, r, p, q, n;
    m = this.rotate;
    var s = this.firstDayOfWeek, t = this.boldPeriodBeginning, a = AmCharts.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * k), this.minPeriod, 1, s).getTime();
...
AmCharts.RecAxis = AmCharts.Class({construct:function (a) {
  var b = a.chart, d = a.axisThickness, e = a.axisColor, f = a.axisAlpha, g = a.offset, h = a.dx, i = a.dy, j = a.viX, k = a.viY, l = a.viH, m = a.viW, r = b.container;
...
AmCharts.RecItem = AmCharts.Class({construct:function (a, b, d, e, f, g, h, i, j) {
  ...
  this.set = p;
  var q = a.axisThickness, n = a.axisColor, s = a.axisAlpha, t = a.tickLength, u = a.gridAlpha, w = a.gridThickness, y = a.gridColor, x = a.dashLength, v = a.fillColor, D = a.fillAlpha, K = a.labelsEnabled, F = a.labelRotation, Y = a.counter, N = a.inside,
      P = a.dx, G = a.dy, V = a.orientation, O = a.position, T = a.previousCoord, ea = a.viH, ba = a.viW, ca = a.offset, ka, U;
  ...
  U = "start";
  f && (U = "middle");
  var Q = F * Math.PI / 180, Z, E = 0, C = 0, z = 0, fa = Z = 0;
  "V" == V && (F = 0);
  if (K)var W = AmCharts.text(r, d, m, k, l, U, i), fa = W.getBBox().width;
  if ("H" == V) {
    if (0 <= b && b <= ba + 1 && (0 < t && (0 < s && b + j <= ba + 1) && (ka = AmCharts.line(r, [b + j, b + j], [0, t], n, s, w), p.push(ka)), 0 < u && (U = AmCharts.line(r, [b, b + P, b + P], [ea, ea + G, G], y, u, w, x), p.push(U))), C = 0, E = b, h && 90 == F && (E -= l), !1 == e ? (U = "start", C = "bottom" == O ? N ? C + t : C - t : N ? C - t : C + t, E += 3, f && (E += f / 2, U = "middle"), 0 < F && (U = "middle")) : U = "middle", 1 == Y && (0 < D && !h && T < ba) && (e = AmCharts.fitToBounds(b, 0, ba), T = AmCharts.fitToBounds(T, 0, ba), Z = e - T, 0 < Z && (fill = AmCharts.rect(r, Z, a.height, v, D), fill.translate(e - Z + P, G), p.push(fill))), "bottom" == O ? (C +=
    ...
    0 <= b && b <= ea + 1 && (0 < t && (0 < s && b + j <= ea + 1) && (ka = AmCharts.line(r,
        [0, t], [b + j, b + j], n, s, w), p.push(ka)), 0 < u && (U = AmCharts.line(r, [0, P, ba + P], [b, b + G, b + G], y, u, w, x), p.push(U)));
    U = "end";
    ...
    ka && ("right" ==
        O ? (z += P + ca + ba, Z += G, z = N ? z - q : z + q) : (z -= ca, N || (z -= t + q)));
    g && (C += g);
    N = -3;
    "right" == O && (N += G);
  ...
  W && (W.attr({"text-anchor":U}), W.translate(E, C), 0 != F && W.rotate(-F), a.allLabels.push(W), " " != d && (this.label = W));
  a.counter = 0 == Y ? 1 : 0;
  a.previousCoord = b;
...
AmCharts.RadAxis = AmCharts.Class({construct:function (a) {
  ...
  if (b) {
    ...
    for (var a = b.chartData, r = a.length, p = 0; p < r; p++) {
      var q = 180 - 360 / r * p, n = g + this.axisWidth * Math.sin(q / 180 * Math.PI), s = h + this.axisWidth * Math.cos(q /
          180 * Math.PI), n = AmCharts.line(b.container, [g, n], [h, s], e, f, d);
      this.set.push(n);
      if (j) {
        var t = "start", n = g + (this.axisWidth + i) * Math.sin(q / 180 * Math.PI), s = h + (this.axisWidth + i) * Math.cos(q / 180 * Math.PI);
...
AmCharts.RadItem = AmCharts.Class({construct:function (a, b, d, e, f, g, h) {
  ...
  this.set = e = l.set();
  var m = a.axisColor, r = a.axisAlpha, p = a.tickLength, q = a.gridAlpha, n = a.gridThickness, s = a.gridColor, t = a.dashLength, u = a.fillColor, w = a.fillAlpha, y = a.labelsEnabled, f = a.counter, x = a.inside, v = a.gridType, b = b - a.height, D, g = a.x, K = a.y;
  ...
  b = a.y - b;
  if ("polygons" == v) {
    for (var P = [], G = [], V = a.data.length, d = 0; d < V; d++)i = 180 - 360 / V * d, P.push(b * Math.sin(i / 180 * Math.PI)), G.push(b * Math.cos(i /
        180 * Math.PI));
    P.push(P[0]);
    G.push(G[0]);
  ...
  if (1 == f && 0 < w && !h) {
    ...
    } else P = AmCharts.wedge(l, 0, 0, 0, -360, b, b, h, 0, {fill:u, "fill-opacity":w, stroke:0, "stroke-opacity":0, "stroke-width":0});
    e.push(P);
    P.translate(g, K)
  }
...
AmCharts.AmGraph = AmCharts.Class({construct:function () {
  ...
  var a = this.id, b = this.index, d = this.data, e = this.chart.container, f = this.valueAxis, g = this.type, h = this.columnWidth, i = this.width, j = this.height, k = this.y, l = this.rotate, m = this.columnCount, r = AmCharts.toCoordinate(this.cornerRadiusTop,
  ...
  var Q = this.chart.columnSpacing,
      Z = N.cellWidth, E = (Z * h - m) / m;
  Q > E && (Q = E);
  var C, z, fa, W = j + 1, Ua = i + 1, Ma = 0, Va = 0, Wa, Xa, Na, Oa, Ab = this.fillColors, Da = this.negativeFillColors, xa = this.negativeLineColor, Ea = this.fillAlphas, Fa = this.negativeFillAlphas;
  ...
  for (L = K; L <= F; L++) {
    ...
    z.index =
        L;
    var na = NaN, B = NaN, A = NaN, R = NaN, M = NaN, Qa = NaN, za = NaN, Ra = NaN, Aa = NaN, X = NaN, $ = NaN, oa = NaN, pa = NaN, S = NaN, ja = void 0, ua = Ab, Ha = Ea, la = ea;
    ...
    if (qa) {
      ...
      var ia = qa.open, A = f.getCoordinate(S);
      ...
      var na = C.x[N.id], va = Math.floor(Z / 2), Ia = va;
      ...
      switch (g) {
        ...
        case "smoothedLine":
          ...
          break;
        case "step":
          isNaN(S) ? p || (t = NaN, this.drawLineGraph(q, n, ga, ha), q = [], n = [], ga = [], ha = []) : (z.isNegative = S < G ? !0 : !1, l ? (isNaN(s) || (q.push(s), n.push(A - va)), n.push(A - va), q.push(B), n.push(A + Ia), q.push(B), Ga && (!isNaN(M) &&
              !isNaN(R)) && (ga.push(R), ha.push(M - va), ga.push(R), ha.push(M + Ia))) : (isNaN(t) || (n.push(t), q.push(B - va)), q.push(B - va), n.push(A), q.push(B + Ia), n.push(A), Ga && (!isNaN(M) && !isNaN(R)) && (ga.push(R - va), ha.push(M), ga.push(R + Ia), ha.push(M))), s = B, t = A, X = B, $ = A, oa = B, pa = A);
          break;
        case "column":
          var ma = la;
          ...
          if (!isNaN(S)) {
            ...
            if (!(S < nb && (ia < nb || void 0 == ia) || S > ob && ia > ob))if (l) {
              if ("3d" == v)var I = A - 0.5 *
                  (h + Q) + Q / 2 + x * V, J = R + y * V; else I = A - (m / 2 - V) * (h + Q) + Q / 2, J = R;
              var H = h, X = B, $ = I + h / 2, oa = B, pa = I + h / 2;
              I + H > j && (H = j - I);
              0 > I && (H += I, I = 0);
              var aa = B - R, Bb = J, J = AmCharts.fitToBounds(J, 0, i), aa = aa + (Bb - J), aa = AmCharts.fitToBounds(aa, -J, i - J + y * V);
              if (I < j && 0 < H && (ja = new AmCharts.Cuboid(e, aa, H, y, x, ua, Ha, O, ma, T, U, r, l), "bottom" != D))if (D = f.reversed ? "left" : "right", 0 > S)D = f.reversed ? "right" : "left"; else if ("regular" == v || "100%" == v)X += this.dx
            } else {
              ...
              J + H > i + V * y && (H = i - J + V * y);
              0 > J && (H += J, J = 0);
              var aa = A - M, Cb = I, I = AmCharts.fitToBounds(I, this.dy, j), aa = aa + (Cb - I), aa = AmCharts.fitToBounds(aa, -I + x * V, j - I);
              if (J < i + V * y && 0 < H)if (ja = new AmCharts.Cuboid(e, H, aa, y, x, ua, Ha, O, ma, this.lineAlpha, U, r, l), 0 > S && "middle" != D)D = "bottom"; else if (D = ka, "regular" == v || "100%" == v)$ += this.dy
            }
            if (ja) {
              var ra = ja.set;
              ra.translate(J, I);
              ...
              if (!Y) {
                ...
                "3d" == v && (l ? (w = (u - b) * (this.end + 1 - L), X += y *
                    this.columnIndex, oa += y * this.columnIndex, z.y += y * this.columnIndex) : (w = (u - b) * (L + 1), X += 3, $ += x * this.columnIndex + 7, pa += x * this.columnIndex, z.y += x * this.columnIndex));
        ...
        case "ohlc":
          if (!isNaN(ia) && !isNaN(Za) && !isNaN(Ya) && !isNaN(S)) {
            ...
            if (l) {
              var hb =
                  A - h / 2, hb = AmCharts.fitToBounds(hb, 0, j), pb = AmCharts.fitToBounds(A, 0, j), ib = A + h / 2, ib = AmCharts.fitToBounds(ib, 0, j);
              ...
              var jb = B - h / 2, jb = AmCharts.fitToBounds(jb, 0, i), qb = AmCharts.fitToBounds(B, 0, i), kb = B + h / 2, kb = AmCharts.fitToBounds(kb, 0, i);
      ...
      if (!Y && !isNaN(S)) {
        ...
        if (this.end - this.start <= rb || 0 == rb) {
          ...
          if (sb) {
            var da = this.createLabel(z, 0, 0, sb), wa = 0, Ca = 0, tb = da.getBBox(), Ta = tb.width, lb = tb.height;
            switch (D) {
              case "left":
                wa = -(Ta / 2 + Ba / 2 + 3);
                break;
              ...
              case "bottom":
                l && "column" == g ? (X = P, 0 > S ? (wa = -6, da.attr({"text-anchor":"end"})) :
                    (wa = 6, da.attr({"text-anchor":"start"}))) : (Ca = Ba / 2 + lb / 2, da.x = -(Ta / 2 + 2));
                break;
              case "middle":
          ...
          if ("column" ==
            ...
            var vb = f.totalText;
            if (vb) {
              var Ja = this.createLabel(z, 0, 0, vb), wb = Ja.getBBox(), xb = wb.width, yb = wb.height, Ka, La, zb = f.totals[L];
              zb && zb.remove();
  ...
  if (1 < a.length) {
    ...
    f.push(h);
    f.push(i);
    var j = this.lineAlpha, k = this.lineThickness, l = this.dashLength, f = this.fillAlphas, m = this.fillColors, r = this.negativeLineColor, p = this.negativeFillColors, q = this.negativeFillAlphas, n = this.baseCoord, s = AmCharts.line(g,
    ...
    if (0 < f && (j = a.join(";").split(";"), k = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), j = a.concat(d), k = b.concat(e)) : this.rotate ? (k.push(k[k.length - 1]), j.push(n), k.push(k[0]), j.push(n), k.push(k[0]), j.push(j[0])) : (j.push(j[j.length - 1]), k.push(n), j.push(j[0]), k.push(n), j.push(a[0]), k.push(k[0]))), a = AmCharts.polygon(g, j, k, m, f, 0, 0, 0, this.gradientRotation), h.push(a), p ||
        void 0 != r))q || (q = f), p || (p = r), g = AmCharts.polygon(g, j, k, p, q, 0, 0, 0, this.gradientRotation), i.push(g);
    this.applyMask(i, h)
  }
  ...
  if (1 < a.length) {
    ...
    f.push(h);
    f.push(i);
    var j = this.lineAlpha, k = this.lineThickness, f = this.dashLength, l = this.fillAlphas, m = this.fillColors, r = this.negativeLineColor, p = this.negativeFillColors,
        q = this.negativeFillAlphas, n = this.baseCoord, s = new AmCharts.Bezier(g, a, b, this.lineColor, j, k, m, 0, f);
    h.push(s.path);
  ...
  legendKeyColor:function () {
    ...
    if ("none" != this.bullet || a.bullet) {
      ...
      f = this.bullet;
      a.bullet && (f = a.bullet);
      var h = this.bulletBorderThickness, k = this.bulletBorderColor, l = this.bulletBorderAlpha, m = this.bulletAlpha, r = a.alpha;
      isNaN(r) || (m = r);
      switch (f) {
        case "round":
    ...
    if (a) {
      var b = this.chart, d = {type:"rollOverGraphItem", item:a,
        index:a.index, graph:this, target:this, chart:this.chart};
    ...
    a && (a = {type:"doubleClickGraphItem", item:a, index:a.index, graph:this, target:this,
      chart:this.chart}, this.fire("doubleClickGraphItem", a), this.chart.fire("doubleClickGraphItem", a))
  }, zoom:function (a, b) {
    this.start = a;
    this.end = b;
    this.draw()
...
AmCharts.ChartCursor = AmCharts.Class({construct:function () {
  ...
  var a = this.chart,
      b = this.cursorAlpha, d = a.categoryAxis, e = d.position, f = d.inside, g = d.axisThickness, h = this.categoryBalloon, i, j, k = a.dx, l = a.dy, m = this.x, r = this.y, p = this.width, q = this.height, a = a.rotate, n = d.tickLength;
  h.pointerWidth = n;
  ...
  a && this.fire("onHideCursor", {type:"onHideCursor",
  ...
  updateCursor:function (a, b) {
    ...
    if (this.enabled) {
      void 0 == b && (b = !0);
      this.index = a;
      var g = d.categoryAxis, h = d.dx, i = d.dy, j = this.x, k = this.y, l = this.width, m = this.height, r = this.data[a], p = r.x[g.id], q = d.rotate, n = g.inside, s = this.stepWidth, t = this.categoryBalloon, u = this.firstTime,
          w = this.lastTime, y = this.cursorPosition, x = g.position, v = this.zooming, D = this.panning, K = d.graphs, F = g.axisThickness;
      if (d.mouseIsOver || v || D || this.forceShow)if (this.forceShow = !1, D) {
        ...
        0 != e && (k = {type:"zoomed", target:this}, k.chart = this.chart, g.parseDates && !g.equalSpacing ? (d + e > w && (e = w - d), v + e < u && (e = u - v), k.start = v + e, k.end = d + e, this.fire(k.type,
        ...
        if (q) {
          if (0 > p)if (v)p = 0; else {
            this.hideCursor();
            return
          }
          if (p > m + 1)if (v)p = m + 1; else {
            this.hideCursor();
            return
          }
        } else {
        ...
        if (K && this.valueBalloonsEnabled && u && d.balloon.enabled) {
          ...
          for (u = 0; u < K.length; u++)if (s = K[u], !(this.oneBalloonOnly &&
              s != Y) && (s.showBalloon && !s.hidden && s.balloonText) && (t = r.axes[s.valueAxis.id].graphs[s.id], w = t.y, !isNaN(w))) {
            p = t.x;
            n = !0;
            if (q) {
              if (i = w, 0 > p || p > m)n = !1
            ...
            n && (n = s.valueBalloon, x = d.getBalloonColor(s, t), n.setBounds(j, k, j + l, k + m), n.pointerOrientation = "H", n.changeColor(x), void 0 != s.balloonAlpha && (n.fillAlpha = s.balloonAlpha), void 0 != s.balloonTextColor && (n.color = s.balloonTextColor), n.setPosition(i + j, p + k), s = d.formatString(s.balloonText, t, s), "" != s && n.showBalloon(s), !q && n.set && n.set.hide(),
                g.push({yy:w, balloon:n}))
          }
          q || this.arrangeBalloons()
        }
        b ? (k = {type:"changed"}, k.index = a, k.target = this, k.chart = this.chart, k.zooming = v, k.position = q ? f : e, k.target = this, d.fire("changed", k), this.fire("changed", k), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, d.updateLegendValues(a));
    ...
    if (a) {
      ...
      if (this.drawingNow) {
        ...
        if (2 < Math.abs(e -
            b) || 2 < Math.abs(f - d))e = {type:"draw", target:this, chart:a, initialX:e, initialY:f, finalX:b, finalY:d}, this.fire(e.type, e)
      }
      if (this.enabled && 0 < this.data.length) {
        if (this.pan)this.rolledOver = !1; else if (this.zoomable && !this.selectWithoutZooming && this.zooming) {
          ...
          if ("cursor" == this.type)this.rotate ? this.selectionPosY = a = d : this.selectionPosX = a = b, 2 > Math.abs(a - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (e.end = this.fromIndex, e.start = this.index) :
              (e.end = this.index, e.start = this.fromIndex), a = this.chart.categoryAxis, a.parseDates && !a.equalSpacing && (e.start = this.data[e.start].time, e.end = this.data[e.end].time), this.skipZoomDispatch || this.fire(e.type, e)); else {
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({construct:function () {
  ...
  d = i.x + f;
  e = i.y + g;
  var j = i.width, i = i.height, k = this.rotate, l = this.chart, m = this.width, r = this.height, p = l.mouseX, q = l.mouseY;
  a = this.initialMouse;
  l.mouseIsOver && (this.dragging && (l = this.initialCoord, k ? (a = l + (q - a), 0 > a && (a = 0), l = r - i, a > l && (a = l), h.setAttr("y", a)) : (a = l + (p - a), 0 > a && (a = 0), l = m - j, a > l && (a = l), h.setAttr("x", a))), this.resizingRight &&
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits:AmCharts.SimpleChartScrollbar, construct:function () {
  ...
  e.zoom(0, d.length - 1);
  if (k = a.graph) {
    var m = a.valueAxis, r = k.valueAxis;
    m.id = r.id;
    m.rotate = f;
    m.setOrientation(f);
    m.width = i;
    ...
    for (var g = Infinity, h = -Infinity, p = 0; p < d.length; p++) {
      var q = d[p].axes[r.id].graphs[k.id].values, n;
...
AmCharts.rect = function (a, b, d, e, f, g, h, i, j, k) {
  ...
  void 0 == h && (h = l);
  void 0 == i && (i = f);
  var b = Math.round(b), d = Math.round(d), r = 0, p = 0;
...
AmCharts.wedge = function (a, b, d, e, f, g, h, i, j, k, l) {
  var m = Math.round, g = m(g), h = m(h), i = m(i), r = m(h / g * i), p = AmCharts.VML, q = -359.5 - g / 100;
  -359.95 > q && (q = -359.95);
  f <= q && (f = q);
  var n = 1 / 180 * Math.PI, q = b + Math.cos(e * n) * i, s = d + Math.sin(-e * n) * r, t = b + Math.cos(e * n) * g, u = d + Math.sin(-e * n) * h, w = b + Math.cos((e + f) * n) * g, y = d + Math.sin((-e - f) * n) * h, x = b + Math.cos((e + f) * n) * i, n = d + Math.sin((-e - f) * n) * r, v = {fill:AmCharts.adjustLuminosity(k.fill, -0.2), "stroke-opacity":0}, D = 0;
  180 < Math.abs(f) && (D = 1);
  var e = a.set(), K;
  p && (q = m(10 * q), t = m(10 * t), w = m(10 *
      w), x = m(10 * x), s = m(10 * s), u = m(10 * u), y = m(10 * y), n = m(10 * n), b = m(10 * b), j = m(10 * j), d = m(10 * d), g *= 10, h *= 10, i *= 10, r *= 10, 1 > Math.abs(f) && (1 >= Math.abs(w - t) && 1 >= Math.abs(y - u)) && (K = !0));
  f = "";
  if (0 < j) {
    p ? (path = " M" + q + "," + (s + j) + " L" + t + "," + (u + j), K || (path += " A" + (b - g) + "," + (j + d - h) + "," + (b + g) + "," + (j + d + h) + "," + t + "," + (u + j) + "," + w + "," + (y + j)), path += " L" + x + "," + (n + j), 0 < i && (K || (path += " B" + (b - i) + "," + (j + d - r) + "," + (b + i) + "," + (j + d + r) + "," + x + "," + (j + n) + "," + q + "," + (j + s)))) : (path = " M" + q + "," + (s + j) + " L" + t + "," + (u + j), path += " A" + g + "," + h + ",0," + D + ",1," +
        w + "," + (y + j) + " L" + x + "," + (n + j), 0 < i && (path += " A" + i + "," + r + ",0," + D + ",0," + q + "," + (s + j)));
    path += " Z";
    c = a.path(path, void 0, void 0, "1000,1000").attr(v);
    e.push(c);
    var F = a.path(" M" + q + "," + s + " L" + q + "," + (s + j) + " L" + t + "," + (u + j) + " L" + t + "," + u + " L" + q + "," + s + " Z", void 0, void 0, "1000,1000").attr(v), j = a.path(" M" + w + "," + y + " L" + w + "," + (y + j) + " L" + x + "," + (n + j) + " L" + x + "," + n + " L" + w + "," + y + " Z", void 0, void 0, "1000,1000").attr(v);
    e.push(F);
    e.push(j)
  }
  p ? (K || (f = " A" + m(b - g) + "," + m(d - h) + "," + m(b + g) + "," + m(d + h) + "," + m(t) + "," + m(u) + "," + m(w) +
      "," + m(y)), g = " M" + m(q) + "," + m(s) + " L" + m(t) + "," + m(u) + f + " L" + m(x) + "," + m(n)) : g = " M" + q + "," + s + " L" + t + "," + u + (" A" + g + "," + h + ",0," + D + ",1," + w + "," + y) + " L" + x + "," + n;
  ...
  if (AmCharts.ifArray(b)) {
    if (0 < a.realWidth && 0 < a.realHeight) {
      ...
      for (l = 0; l < b.length; l++)if (f = b[l], !0 != f.hidden && 0 < f.percents) {
        var s = 360 * -f.percents / 100, j = Math.cos((g + s / 2) / 180 * Math.PI), n = Math.sin((-g - s / 2) / 180 * Math.PI) * (k / p), i = {fill:f.color, stroke:a.outlineColor, "stroke-width":a.outlineThickness, "stroke-opacity":a.outlineAlpha};
...
AmCharts.VMLRenderer = AmCharts.Class({construct:function (a) {
  ...
  for (var b = a.split(" "),
    ...
    "Z" == h && (a += " x e");
    if ("Q" == h) {
      var k = d.length, l = d[k - 1], m = i[0], r = i[1], j = i[2], p = i[3];
      d = e(d[k - 2] / 3 + 2 / 3 * m);
      l = e(l / 3 + 2 / 3 * r);
      m = e(2 / 3 * m + j / 3);
      r = e(2 / 3 * r + p / 3);
  ...
  if ("translate" == b) {
    var i = d.split(","), b =
        i[1], d = h.offsetTop, h = {obj:a, frame:0, attribute:"left", from:h.offsetLeft, to:i[0], time:e, effect:f};
    g.animations.push(h);
